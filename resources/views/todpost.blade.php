@extends('layouts.app')
@section('title')
<title>Blog | Todos los Post</title>
@endsection
@section('content')
<section id="postview">
    ...
    <div class="row no-gutters">
      <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8"style="padding: 0rem .4rem;margin-bottom: 30px">
        <div id="header" style="" class="d-flex justify-content-between mb-4">
          <h1 class="align-self-center" style="color:#6c02fc">Todos los Posts</h1>
          <img src="{{asset('img/posts.svg')}}" alt="" srcset="" height="102px">
        </div>
            ...
            <div class="row no-gutters">
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <p class="card-text my-1"><span class="text-muted">{{$post->created_at}} | {{$post->user->name}}</span>
                  </p>
                  <a href="/{{strtolower($post->categoria->name)}}">
                    <h6>
                        <span class="badge badge-secondary"
                            id="btn-grad">{{$post->categoria->name}}</span>
                    </h6>
                  </a>
                </div>
              </div>
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4" style="padding: 0rem .4rem;" id="sidebar">
        ...
        <div class="" style="margin-top:60px">
          <div class="card" style="">
            ...
            background: linear-gradient(0deg, rgba(55,2,128,1) 7%, rgba(61,6,135,0.9023984593837535) 12%, rgba(108,2,252,0) 36%),url('{{asset('storage/uploads/' . $vid->imagen)}}');
            background-size:cover;
            background-position:center;
            ...
            <div class="card-body" style="background:#370280;color:white;padding-top:5px;
                padding-bottom:5px">
              <h5 class="card-title"><a href="{{ route('mostrarpost', $vid->id) }}" style="text-decoraton:none;color:white">{{$vid->title}}</a></h5>
            </div>
