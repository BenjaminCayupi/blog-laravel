    ...
    <div class="row no-gutters">
      <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8"style="padding: 0rem .4rem;margin-bottom: 30px">
        <div id="header" style="" class="d-flex justify-content-between mb-4">
          <h1 class="align-self-center" style="color:#6c02fc">Cine</h1>
          <img src="{{asset('img/cine.svg')}}" alt="" srcset="" height="102px">
        </div>
        @foreach ($cine as $post)
      ...
      <div class="col-12 col-md-12 col-lg-4 float-right" style="padding: 0rem .4rem;">
        <h3 style="color:#6c02fc;" class="align-self-center">Noticias que podrian interesarte</h3>
        <div class="" style="margin-top:61px">
          <div class="card" style="">

            <div class="" style="height: 200px;
            background: rgb(55,2,128);
            background: linear-gradient(0deg, rgba(55,2,128,1) 7%, rgba(61,6,135,0.9023984593837535) 12%, rgba(108,2,252,0) 36%),url('{{asset('storage/uploads/' . $cin->imagen)}}');
            background-size:cover;
            background-position:center;
            ...
            <div class="card-body" style="background:#370280;color:white;padding-top:5px;
                padding-bottom:5px">
              <h5 class="card-title"><a href="{{ route('mostrarpost', $cin->id) }}" style="text-decoraton:none;color:white">{{$cin->title}}</a></h5>
            </div>
