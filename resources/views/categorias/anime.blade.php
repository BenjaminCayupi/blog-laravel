    ...
    <div class="row no-gutters">
      <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8"style="padding: 0rem .4rem;margin-bottom: 30px">
        <div id="header" style="" class="d-flex justify-content-between mb-4">
          <h1 class="align-self-center" style="color:#6c02fc">Anime</h1>
          <img src="{{asset('img/anim.svg')}}" alt="" srcset="" width="142px">
        </div>
        @foreach ($animes as $post)
        <div class="" style="">
          <div class="card mb-3">
            <div class="row no-gutters">
              <div class="col-md-4">
              ...
              <div class="col-md-8" style="padding: 0rem .4rem">
                <div class="card-body">
        ...
        @endforeach
        <div>{{$animes->links()}}</div>


      </div>
      <div class="col-md-4 col-lg-4 float-right" style="padding: 0rem .4rem;">
        ...
        <div class="" style="margin-top:61px">
          <div class="card" style="">
            ...
            background: linear-gradient(0deg, rgba(55,2,128,1) 7%, rgba(61,6,135,0.9023984593837535) 12%, rgba(108,2,252,0) 36%),url('{{asset('storage/uploads/' . $ani->imagen)}}');
            background-size:cover;
            background-position:center;
            ...
            <div class="card-body" style="background:#370280;color:white;padding-top:5px;
                padding-bottom:5px">
              <h5 class="card-title"><a href="{{ route('mostrarpost', $ani->id) }}" style="text-decoraton:none;color:white">{{$ani->title}}</a></h5>
            </div>
