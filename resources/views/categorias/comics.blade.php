    ...
    <div class="row no-gutters">
      <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8"style="padding: 0rem .4rem;margin-bottom: 30px">
        <div id="header" style="" class="d-flex justify-content-between mb-4">
          <h1 class="align-self-center" style="color:#6c02fc">Comics</h1>
          <img src="{{asset('img/com.svg')}}" alt="" srcset="" height="102px">
        </div>
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4" style="padding: 0rem .4rem;" id="sidebar">
        ...
        <div class="" style="margin-top:61px">
          <div class="card" style="">
            ...
            background: linear-gradient(0deg, rgba(55,2,128,1) 7%, rgba(61,6,135,0.9023984593837535) 12%, rgba(108,2,252,0) 36%),url('{{asset('storage/uploads/' . $com->imagen)}}');
            background-size:cover;
            background-position:center;
            ...
            <div class="card-body" style="background:#370280;color:white;padding-top:5px;
                padding-bottom:5px">
              <h5 class="card-title"><a href="{{ route('mostrarpost', $com->id) }}" style="text-decoraton:none;color:white">{{$com->title}}</a></h5>
            </div>
