  ...
  <div class="container" id="contenedorgral" style="margin-top:80px;margin-bottom:80px">
    <div class="row">
      <div class="col-md-8 col-lg-8">
        <div id="header" style="padding: 0rem .4rem" class="d-flex justify-content-between mb-4">
          <h1 class="align-self-center" style="color:#6c02fc">Reviews</h1>
          <img src="{{asset('img/trend.svg')}}" alt="" srcset="" width="190px">
        </div>
        @foreach ($reviews as $post)
        <div class="col-12" style="padding: 0rem .4rem">
          <div class="card mb-3" >
            <div class="row no-gutters">
              ...
              <div class="col-md-8">
                <div class="card-body">
                  <a href="" class="card-title" id="headlink">{{$post->title}}</a>
      ...
      <div class="col-md-4 col-lg-4 float-right" style="padding-top:35px">
        ...
        <div class="" style="margin-top:61px">
          <div class="card" style="">
            ...
            background: linear-gradient(0deg, rgba(55,2,128,1) 7%, rgba(61,6,135,0.9023984593837535) 12%, rgba(108,2,252,0) 36%),url('{{asset('storage/uploads/' . $rv->imagen)}}');
            background-size:cover;
            background-position:center;
            ...
            <div class="card-body" style="background:#370280;color:white;padding-top:5px;
                padding-bottom:5px">
              <h5 class="card-title"><a href="{{ route('mostrarpost', $rv->id) }}" style="text-decoraton:none;color:white">{{$rv->title}}</a></h5>
            </div>
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item" id="ulreview">
                <a href="{{ route('mostrarpost', $ser->id) }}">
                  {{$ser->title}}
                </a>
              </li>
              <li class="list-group-item" id="ulreview">
